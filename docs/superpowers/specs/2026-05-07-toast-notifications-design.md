# Toast Notifications (PrimeVue) – 10 Sekunden, oben rechts
...
- Anzeigeort bleibt **oben rechts** (Corner), entsprechend der globalen Toast-Instanz.
...
## Design / Entscheidung
- PrimeVue Toast bleibt global in `web/src/App.vue` eingebunden und **positioniert sich oben rechts** (`top-right`).
